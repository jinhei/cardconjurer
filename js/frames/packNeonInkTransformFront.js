...
var masks = [{ src: 'img/frames/neonInk/transform/front/masks/maskCrown.png', name: 'Crown' }, { src: 'img/frames/neonInk/masks/maskTypePinlines.png', name: 'Type Pinlines' }, { src: 'img/frames/neonInk/transform/front/masks/maskTitle.png', name: 'Title' }, { src: 'img/frames/neonInk/masks/maskType.png', name: 'Type' }];
var masks2 = [{ src: 'img/frames/neonInk/pt/masks/maskPinlines.png', name: 'PT Pinlines' }];
var bounds = { x: 0, y: 0, width: 1, height: 1 };
//defines available frames
availableFrames = [
	{ name: 'White Frame', src: 'img/frames/neonInk/transform/front/w.png', masks: masks },
	{ name: 'Blue Frame', src: 'img/frames/neonInk/transform/front/u.png', masks: masks },
	{ name: 'Black Frame', src: 'img/frames/neonInk/transform/front/b.png', masks: masks },
	{ name: 'Red Frame', src: 'img/frames/neonInk/transform/front/r.png', masks: masks },
	{ name: 'Green Frame', src: 'img/frames/neonInk/transform/front/g.png', masks: masks },
	{ name: 'Multicolored Frame', src: 'img/frames/neonInk/transform/front/m.png', masks: masks },
	{ name: 'Artifact Frame', src: 'img/frames/neonInk/transform/front/a.png', masks: masks },
	{ name: 'Colorless Frame', src: 'img/frames/neonInk/transform/front/c.png', masks: masks },
	{ name: 'Land Frame', src: 'img/frames/neonInk/transform/front/L.png', masks: masks },
	{ name: 'Black Frame (Alt)', src: 'img/frames/neonInk/transform/front/b(Alt).png', masks: masks },
...
document.querySelector('#loadFrameVersion').onclick = async function () {
	...
	loadTextOptions({
		...
		title: { name: 'Title', text: '', x: 330 / 2010, y: 163 / 2814, width: 0.8292, height: 0.0543, oneLine: true, font: 'belerenb', size: 0.0381, color: 'white' },
