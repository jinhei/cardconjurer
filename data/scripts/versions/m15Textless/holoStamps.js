if (!loadedVersions.includes('m15Textless/holoStamps')) {
	loadedVersions.push("m15Textless/holoStamps")
	loadFrameImages([
	...
	], 'frameClassM15TextlessHoloStamps')
}

hideFrameImages('frameClassM15TextlessHoloStamps')